// Stash module — database schema (inventory management)
// Owns: parts, suppliers, purchase orders, FIFO cost layers, inventory, transactions.
// Depends on the shared/core `locations` table (created by db/schema.js before this runs).

export async function createStashTables(pool) {
  await pool.query(`
    -- Parts catalog
    ...
    -- FIFO Cost Layers (location_id references the shared core locations table)
